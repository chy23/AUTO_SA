export const LAYOUT_HORIZONTAL = {
  seats: [
    { id: 1, groupId: 5, x: 14.0, y: 17.0, shape: 'vertical' },
    { id: 2, groupId: 5, x: 14.0, y: 30.0, shape: 'vertical' },
    { id: 3, groupId: 5, x: 14.0, y: 43.0, shape: 'horizontal' },
    { id: 6, groupId: 5, x: 27.0, y: 17.0, shape: 'vertical' },
    { id: 7, groupId: 5, x: 27.0, y: 43.0, shape: 'horizontal' },
    
    { id: 4, groupId: 4, x: 14.0, y: 56.0, shape: 'vertical' },
    { id: 5, groupId: 4, x: 14.0, y: 69.0, shape: 'vertical' },
    { id: 10, groupId: 4, x: 14.0, y: 82.0, shape: 'horizontal' },
    { id: 8, groupId: 4, x: 27.0, y: 56.0, shape: 'horizontal' },
    { id: 9, groupId: 4, x: 27.0, y: 82.0, shape: 'horizontal' },
    
    { id: 11, groupId: 3, x: 43.5, y: 56.0, shape: 'horizontal' },
    { id: 12, groupId: 3, x: 56.5, y: 56.0, shape: 'horizontal' },
    { id: 13, groupId: 3, x: 43.5, y: 82.0, shape: 'horizontal' },
    { id: 14, groupId: 3, x: 56.5, y: 82.0, shape: 'horizontal' },
    
    { id: 15, groupId: 1, x: 73.0, y: 17.0, shape: 'vertical' },
    { id: 21, groupId: 1, x: 86.0, y: 17.0, shape: 'vertical' },
    { id: 18, groupId: 1, x: 86.0, y: 30.0, shape: 'vertical' },
    { id: 16, groupId: 1, x: 73.0, y: 43.0, shape: 'horizontal' },
    { id: 22, groupId: 1, x: 86.0, y: 43.0, shape: 'horizontal' },
    
    { id: 19, groupId: 2, x: 73.0, y: 56.0, shape: 'horizontal' },
    { id: 23, groupId: 2, x: 86.0, y: 56.0, shape: 'vertical' },
    { id: 24, groupId: 2, x: 86.0, y: 69.0, shape: 'vertical' },
    { id: 17, groupId: 2, x: 73.0, y: 82.0, shape: 'horizontal' },
    { id: 20, groupId: 2, x: 86.0, y: 82.0, shape: 'horizontal' },
  ],
  labels: [
    { text: '5', x: 27.0, y: 30.0 },
    { text: '4', x: 27.0, y: 69.0 },
    { text: '3', x: 50.0, y: 69.0 },
    { text: '1', x: 73.0, y: 30.0 },
    { text: '2', x: 73.0, y: 69.0 },
  ],
  staticItems: [
